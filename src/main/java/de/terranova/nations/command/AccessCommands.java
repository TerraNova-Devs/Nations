...
public class AccessCommands {
    ...
    @CommandAnnotation(domain = "access.invite.$ONLINEPLAYERS", permission = "nations.access.ranks", description = "Lädt den angegebenen Spieler in deine Stadt ein.", usage = "/terra access invite <player>")
    ...
    @CommandAnnotation(domain = "access.accept", permission = "nations.access.ranks", description = "Nimmt die Einladung einer Stadt an.", usage = "/terra access accept")
    ...
    @CommandAnnotation(domain = "access.leave", permission = "nations.access.ranks", description = "Verlässt eine Stadt.", usage = "/terra leave")
    ...
    @CommandAnnotation(domain = "access.rank.$REGION_ACCESS_USERS.$RANKS", permission = "nations.access.ranks", description = "Setzt den Rang eines Spielers", usage = "/terra rank <player> <rank>")
