...
public abstract class AbstractCommand implements CommandExecutor, TabCompleter {
  ...
  // Old: protected Map<String, Supplier<List<String>>> commandTabPlaceholders =
  ...
  /**
   * Here we now return a Map<String, PlayerAwarePlaceholder> instead of Map<String,
    ...
    if (!commandMethods.containsKey("help")) {
      try {
        ...
        for (String group : commandClassInstances.keySet()) {
          newEntries.put(
              "help." + group,
              AbstractCommand.class.getDeclaredMethod(
                  "help", Player.class, String[].class, String.class, Map.class));
        }
  ...
  protected void initialize() {
    ...
    tabResolver =
        new DomainTabCompletionResolver(
            new ArrayList<>(commandMethods.keySet()), commandTabPlaceholders);
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
    ...
    if (annotation != null
      ...
      player.sendMessage(
          "You do not have permission (" + annotation.permission() + ") to execute this command.");
      return true;
    }
    ...
    try {
      if (commandMethod.getName().equals("help")) {
        return help(
            ...
            command.getName(),
            Stream.concat(
                    commandClassInstances.entrySet().stream()
        ...
        throw new RuntimeException(
            "Error: Command was found but no instance was available to invoke it.");
      }
    } catch (Exception e) {
  ...
  public boolean help(
      Player p, String[] args, String commandPrefix, Map<String, Class<?>> commandClasses) {
    ...
    p.sendMessage(
        Chat.greenFade(
                "---------" + commandClasses.get(args[1]).getSimpleName() + " Help ---------")
