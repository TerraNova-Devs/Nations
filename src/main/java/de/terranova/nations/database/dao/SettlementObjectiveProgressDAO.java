...
public class SettlementObjectiveProgressDAO {
  ...
  /**
   * Lädt den gesamten Fortschritt aller Objectives für eine bestimmte Stadt. Gibt ein
   * Map<ObjectiveID, Progress> zurück.
   */
  ...
  /**
   * Setzt den Fortschritt eines konkreten Objectives auf einen neuen Wert (anstatt nur +1 wie in
   * addProgress).
   */
