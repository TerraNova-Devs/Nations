...
public class TownSettingsGUI extends RoseGUI {
  ...
  public void onOpen(InventoryOpenEvent event) {
    ...
    addStateFlag(
        Flags.LEAF_DECAY, 12, Material.OAK_LEAVES, "Sollen Blätter in deiner Stadt verschwinden?");
    addStateFlag(
        Flags.FROSTED_ICE_FORM,
        13,
        Material.ICE,
        "Soll Frostwalker in deiner Stadt funktionieren?");
    addStateFlag(
        Flags.FIRE_SPREAD,
        14,
        Material.FLINT_AND_STEEL,
        "Soll sich Feuer in deiner Stadt ausbreiten?");
    addStateFlag(
        Flags.ENDERPEARL,
        15,
        Material.ENDER_PEARL,
        "Sollen Enderperlen in deiner Stadt funktionieren?");
    addStateFlag(
        Flags.CHORUS_TELEPORT,
        16,
        Material.CHORUS_FRUIT,
        "Sollen Chorusfrüchte in deiner Stadt funktionieren?");
    addSetFlag(
        Flags.DENY_SPAWN,
        19,
        Material.ZOMBIE_HEAD,
        "Sollen Monster in deiner Stadt spawnen?",
