...
public class PropertyGUI extends RoseGUI {
    ...
    public void onOpen(InventoryOpenEvent event) {
        ...
        RoseItem blue = new RoseItem.Builder()
                .material(Material.BLUE_STAINED_GLASS_PANE)
                .displayName("")
                .build();
        RoseItem cyan = new RoseItem.Builder()
        ...
        RoseItem worth = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
        addItem(worth,13);

        RoseItem triggerBuy = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
        RoseItem percentBuy = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
        ...
        RoseItem triggerRent = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
        RoseItem percentRent = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
        ...
        RoseItem triggerLease = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
        RoseItem percentLease = new RoseItem.Builder()
                .material(Material.GOLD_BLOCK)
                .displayName("3000 S")
                .build();
