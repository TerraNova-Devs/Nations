...
public class BannerRenderer {
    ...
    /**
     * Colorize a white overlay to the given Color, preserving alpha.
     * White pixels get replaced by 'color'; transparent remains transparent.
     */
        ...
        for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
                ...
                if (alpha == 0) {
                    ...
                    int tinted = (0xFF << 24) | (color.getRed() << 16) | (color.getGreen() << 8) | color.getBlue();
