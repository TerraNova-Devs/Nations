...
public class UniqueTimestampGenerator {
  ...
  /**
   * Generates a unique timestamp for a specific UUID. Ensures that timestamps are unique for each
   * UUID but can overlap across different UUIDs. (Exact up to microseconds)
   *
