...
public class TaskTrigger {
  ...
  /**
   * Schedule the task to fire at the given moment. Cancels any previous schedule for this trigger.
   *
  ...
  /**
   * Returns how much time is left until this trigger is executed. If no task is currently
   * scheduled, {@link Duration#ZERO} is returned.
   *
  ...
  /** Shut down the shared scheduler. Call once when your application is terminating. */
