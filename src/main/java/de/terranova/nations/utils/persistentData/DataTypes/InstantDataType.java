package de.terranova.nations.utils.persistentData.DataTypes;
...
public class InstantDataType implements PersistentDataType<byte[], Instant> {
  ...
  @Override
  public @NotNull Instant fromPrimitive(
      byte @NotNull [] bytes, @NotNull PersistentDataAdapterContext persistentDataAdapterContext) {
    try {
