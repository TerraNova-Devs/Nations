...
public class InstantGenerator {
    ...
    private static final Map<String, Instant> STRING_INSTANT_MAP = new ConcurrentHashMap<>();
    /**
    ...
    /**
     * Generates an Instant for the given String, ensuring strictly increasing
     * microsecond-level timestamps for each String.
     *
     * @param str the String for which we want an Instant
     * @return the resulting Instant (with microsecond ordering guaranteed)
     */
    public static Instant generateInstant(String str) {
        ...
        // Retrieve any previously stored Instant for this String
        Instant oldInstant = STRING_INSTANT_MAP.get(str);
        ...
        // Store and return the final Instant
        STRING_INSTANT_MAP.put(str, newInstant);
        return newInstant;
    }
