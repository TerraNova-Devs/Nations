package de.nekyia.nations.regions.rank;
...
public class RankObjective implements Serializable {
    ...
    public RankObjective(int score, int silver, int objective_a, int objective_b, int objective_c, String material_a, String material_b, String material_c) {
        this.score = score;
